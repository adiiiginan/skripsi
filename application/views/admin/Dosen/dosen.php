        ...
        <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
            ...
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                ...
                <li class="breadcrumb-item text-gray-600">
                    <a href="../../demo20/dist/index.html" class="text-gray-600 text-hover-primary">Admin</a>
                </li>
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600">Dosen</li>
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600">List Dosen</li>
                                    ...
                                    <form id="kt_modal_add_user_form" class="form" action="#">
                                        ...
                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="nama" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Full name" value="Adi Ginandani" />
                                                <!--end::Input-->
                                            </div>
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="nidn" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="NIDN" value="320120937" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="email" name="email" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example@domain.com" value="adiginandani@com" />
                                                <!--end::Input-->
                                            </div>
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                <label class="required fw-semibold fs-6 mb-2">No Telephone</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="email" name="telp" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="08*********" value="08*********" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Input group-->
                                            <div class="mb-7">
                                                <!--begin::Label-->
                                                <label class="required fw-semibold fs-6 mb-5">Jabatan</label>
                                                <?php foreach ($dosen as $d) : ?>
                                                    <div class="d-flex fv-row">
                                                        <!--begin::Radio-->
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            <!--begin::Input-->
                                                            <input class="form-check-input me-3" name="jafung" type="radio" value="<?= $d->id; ?>" id="kt_modal_update_role_option_0" checked='checked' />
                                                            <!--end::Input-->
                                                            <!--begin::Label-->
                                                            <label class="form-check-label" for="kt_modal_update_role_option_0">
                                                                <div class="fw-bold text-gray-800"><?= $d->jabatan; ?></div>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Kode Dosen</th>
                            ...
                            <tr>
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="../../demo20/dist/apps/user-management/users/view.html">
                                            <div class="symbol-label">
                                                <img src="assets/media/avatars/300-6.jpg" class="w-100" />
                                            </div>
                                        </a>
                                    </div>

                                    <div class="d-flex flex-column">
                                        <a href="../../demo20/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1"><?= $admin['nama']; ?></a>
                                        <span><?= $admin['nidn']; ?></span>
                                    </div>
                                    <!--begin::User details-->
                                </td>
                                ...
                                <td>
                                    <div class="badge badge-light fw-bold"><?php
                                                                            // Ambil nama dimensi berdasarkan iddimensi
                                                                            $id = $admin['jafung'];
                                                                            $jabatan = $this->db->where('id', $id)->get('jabatan')->row_array();
                                                                            echo $jabatan['jabatan']; ?></div>
                                </td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="<?= base_url(); ?>admin/hapusDosen/<?= $admin['nidn']; ?>" class="menu-link px-3" data-kt-users-table-filter="delete_row">Delete</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
