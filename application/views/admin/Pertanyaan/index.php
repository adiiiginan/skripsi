    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
        ...
        <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
            ...
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600">Pertanyaan</li>
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600">List Pertanyaan</li>
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">
                            ...
                            <!--end::Svg Icon-->Add Pertanyaan</button>
                        <!--end::Add user-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header" id="kt_modal_add_user_header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bold">Add Pertanyaan</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
                                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-users-modal-action="close">
                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                                ...
                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                    <!--begin::Form-->
                                    <form id="kt_modal_add_user_form" class="form" action="<?= base_url(); ?>admin/tbhPertanyaanMK" method="post">
                                        <!--begin::Scroll-->
                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <select name="id_akademik" class="form-control form-control-solid mb-3 mb-lg-0">
                                                    <option value="">--- Pilih Tahun ---</option>
                                                    <?php foreach ($akademi as $d) : ?>

                                                        <option value="<?= $d->id_akademik; ?>"><?= $d->tahun; ?></option>
                                            ...
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                <label class="required fw-semibold fs-6 mb-2">Pertanyaan</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="pertanyaan" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="example" required />
                                                <!--end::Input-->
                                            </div>
                                            ...
                                            <div class="mb-7">
                                                <!--begin::Label-->
                                                <label class="required fw-semibold fs-6 mb-5">Indikator</label>
                                                <?php foreach ($indikator as $d) : ?>
                                                    <div class="d-flex fv-row">
                                                        <!--begin::Radio-->
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            <!--begin::Input-->
                                                            <input class="form-check-input me-3" name="iddimensi" type="radio" value="<?= $d->Id; ?>" id="kt_modal_update_role_option_0" checked='checked' />
                                                            <!--end::Input-->
                                                            <!--begin::Label-->
                                                            <label class="form-check-label" for="kt_modal_update_role_option_0">
                                                                <div class="fw-bold text-gray-800"></div>
                                                                <div class="text-gray-600"><?= $d->Dimensi; ?></div>
                                                            </label>
                                                            <!--end::Label-->
                                                        </div>
                                                        <!--end::Radio-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Kode Pertanyaan</th>
                    ...
                    <?php foreach ($soal as $a) : ?>
                        <tbody class="text-gray-600 fw-semibold">
                            ...
                            <tr>
                                ...
                                <td><?= $a['id_soal_aspek']; ?></td>
                                <td><?= $a['pertanyaan']; ?></td>
                                <td><?php
                                    // Ambil nama dimensi berdasarkan iddimensi
                                    $iddimensi = $a['iddimensi'];
                                    $dimensi = $this->db->where('Id', $iddimensi)->get('dimensi')->row_array();
                                    echo $dimensi['Dimensi']; ?></td>

                                <td><?php
                                    $akademi = $a['idakademik'];
                                    $akademi = $this->db->where('id_akademik', $akademi)->get('akademik')->row_array();
                                    echo $akademi['tahun']; ?></td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="<?= base_url(); ?>admin/hapusMaster/<?= $admin['idmk']; ?>" class="menu-link px-3" data-kt-users-table-filter="delete_row">Delete</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
