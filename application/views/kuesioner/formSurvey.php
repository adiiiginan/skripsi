<div class="toolbar mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap gap-2">
        ...
        <div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bold m-0 fs-3">Activity</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600">Mahasiswa</li>
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-500">Kuesioner</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
    ...
    <div class="content flex-row-fluid" id="kt_content">
                        ...
                        <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-10 p-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                ...
                                <div class="fw-semibold">
                                    <h4 class="text-gray-900 fw-bold">Pilihlah satu jawaban pada Indikator Performance dan Indikator Importance sesuai dengan keadaan yang anda alami ! </h4>
                                    <div class="fs-6 text-gray-700">Berikan Tanda Checklist.
                                        <br />
                                        <br />
                                        <div class="table-responsive">
                                            <ul class="list-unstyled">
                                                <li><strong>PERFORMANCE</strong>: SB (Sangat Baik), B (Baik), TB (Tidak Baik), STB (Sangat Tidak Baik)</li>
                                                <li><strong>IMPORTANCE</strong>: SP (Sangat Penting), P (Penting), TP (Tidak Penting), STP (Sangat Tidak Penting)</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_notifications" aria-expanded="true" aria-controls="kt_account_notifications">
                ...
                ?>
                <div class="card-title m-0">
                    <h3 class="fw-bold "><?= $detail['matakuliah']; ?></h3><br>
                    <h6>&nbsp;(Dosen : <?= $detail['nama']; ?>)</h6>
                    <input type="hidden" name="id_survei" id="" value="<?= $detail['id_survei_matakuliah']; ?>">
                    <input type="hidden" name="idkm" id="" value="<?= $detail['idkm']; ?>">
            ...
            <div id="kt_account_settings_notifications" class="collapse show">
                <!--begin::Form-->
                <form class="form" action="<?php echo site_url('Kuesioner/aksiMK'); ?>" method="post">
                    <!--begin::Card body-->
                    <input type="hidden" name="id_survei_matakuliah" value="<?= $detail['id_survei_matakuliah']; ?>">
                        ...
                        <div class="table-responsive">
                            <table class="table table-row-dashed border-gray-300 align-middle gy-6">
                                <tbody class="fs-6 fw-semibold">
                                    ...
                                    <tr>
                                        <td class="min-w-250px fs-4 fw-bold">KUESIONER</td>
                                        <td class="w-125px">
                                            <div class="form-check form-check-custom form-check-solid">
                                                <label class="form-check-label ps-2" for="kt_settings_notification_email">PERFORMANCE</label>
                                            </div>
                                        </td>
                                        <td class="w-125px">
                                            <div class="form-check form-check-custom form-check-solid">
                                                <label class="form-check-label ps-2" for="kt_settings_notification_phone">IMPORTANCE</label>
                                            </div>
                                        </td>
                                    </tr>
                                    <!--begin::Table row-->
                                    <?php if (!empty($detail)) { ?>
                                        ...
                                        foreach ($soal as $soal) { ?>
                                            <tr>
                                                <td><?= $i ?>. <?= $soal['pertanyaan']; ?></td>
                                                <td>
                                                    <input type="hidden" name="id_survey_matakuliah" value="">
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input" type="checkbox" value="4" id="performance[]" name="performance[]">
                                                        <label class="form-check-label ps-2" style="margin-right: 10px;" for="performance[]">SB</label>
                                                        <input class="form-check-input" type="checkbox" value="3" id="performance[]" name="performance[]">
                                                        <label class="form-check-label ps-2" style="margin-right: 10px;" for="performance[]">B</label>
                                                        <input class="form-check-input" type="checkbox" value="2" id="performance[]" name="performance[]">
                                                        <label class="form-check-label ps-2" style="margin-right: 10px;" for="performance[]">TB</label>
                                                        <input class="form-check-input" type="checkbox" value="1" id="performance[]" name="performance[]">
                                                        <label class="form-check-label ps-2" style="margin-right: 10px;" for="performance[]">STB</label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        <input class="form-check-input" type="checkbox" value="4" id="importance[]" name="importance[]">
                                                        <label class="form-check-label ps-2" style="margin-right: 10px;" for="importance[]">SP</label>
                                                        <input class="form-check-input" type="checkbox" value="3" id="importance[]" name="importance[]">
                                                        <label class="form-check-label ps-2" style="margin-right: 10px;" for="importance[]">P</label>
                                                        <input class="form-check-input" type="checkbox" value="2" id="importance[]" name="importance[]">
                                                        <label class="form-check-label ps-2" style="margin-right: 10px;" for="importance[]">TP</label>
                                                        <input class="form-check-input" type="checkbox" value="1" id="importance[]" name="importance[]">
                                                        <label class="form-check-label ps-2" style="margin-right: 10px;" for="importance[]">STP</label>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <button class="btn btn-primary px-6">Selesai</button>
                    </div>
                    <!--end::Card footer-->
                </form>
                <!--end::Form-->
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        <!--begin::Icon-->
                                        <img alt="../../demo20/dist/apps/projects/project.html" class="w-30px me-3" src="<?= base_url('assets/'); ?>/media/svg/files/doc.svg" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-semibold">
                                            <!--begin::Desc-->
                                    ...
                                    <div class="d-flex flex-aligns-center">
                                        <!--begin::Icon-->
                                        <img alt="../../demo20/dist/apps/projects/project.html" class="w-30px me-3" src="<?= base_url('assets/'); ?>/media/svg/files/css.svg" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-semibold">
                                            <!--begin::Desc-->
                                    ...
                                    <div class="row gy-10">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo1/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo1.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo2/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo2.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo6/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo6.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo3/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo3.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo8/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo8.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo10/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo10.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo11/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo11.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo4/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo4.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo27/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo27.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo20/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo20.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo25/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo25.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo30/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo30.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo23/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo23.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo41/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo41.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo42/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo42.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo37/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo37.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo32/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo32.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo36/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo36.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo38/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo38.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo34/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo34.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo31/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo31.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo29/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo29.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo33/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo33.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo35/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo35.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo14/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo14.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo24/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo24.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo26/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo26.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo7/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo7.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo22/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo22.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo28/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo28.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo19/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo19.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo9/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo9.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo13/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo13.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo16/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo16.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo18/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo18.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo21/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo21.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo12/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo12.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo17/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo17.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo15/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo15.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="https://preview.keenthemes.com/metronic8/demo5/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/demos/demo5.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                    ...
                                    <div class="row gy-10">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/index.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/multipurpose-demo20.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/marketing.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/marketing.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/social.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/social.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/ecommerce.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/ecommerce.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/store-analytics.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/store-analytics.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/logistics.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/logistics.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/delivery.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/delivery.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/online-courses.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/online-courses.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/school.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/school.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/crypto.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/crypto.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/finance-performance.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/finance-performance.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/website-analytics.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/website-analytics.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/bidding.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/bidding.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/podcast.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/podcast.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/projects.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/projects.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/call-center.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/call-center.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="../../demo20/dist/dashboards/pos.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/dashboards/pos.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                    ...
                                    <div class="row gy-10">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="../../demo20/dist/apps/projects/list/list.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/apps/projects.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="../../demo20/dist/apps/ecommerce/catalog/products/products.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/apps/ecommerce.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="../../demo20/dist/apps/customers/list/list.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/apps/customers.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="../../demo20/dist/apps/subscriptions/list/list.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/apps/subscriptions.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="../../demo20/dist/apps/user-management/users/list/list.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/apps/user-management.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="../../demo20/dist/apps/invoices/create/main.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/apps/invoices.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="../../demo20/dist/apps/support-center/overview/main.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/apps/support-center.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="../../demo20/dist/apps/chat/private.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/apps/chat.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="../../demo20/dist/apps/calendar/calendar.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/apps/calendar.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="../../demo20/dist/apps/file-manager/list/folders.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/apps/file-manager.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="../../demo20/dist/apps/inbox/listing/listing.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/apps/inbox.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <a href="../../demo20/dist/apps/contacts/getting-started.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                ...
                                                <!--begin::Thumbnail-->
                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/apps/contacts.png" class="lozad w-100 rounded" />
                                                </span>
                                                <!--end::Thumbnail-->
                                            </a>
                                            <!--end::Preview-->
                                            ...
                                            <div class="row g-10">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/layouts/corporate/sign-in.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/auth-corporate.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/layouts/creative/sign-in.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/auth-creative.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/layouts/fancy/sign-in.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/auth-fancy.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/layouts/overlay/sign-in.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/auth-overlay.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/extended/multi-steps-sign-up.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/auth-multistep.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/extended/two-factor-auth.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/auth-2factor.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/general/password-confirmation.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/auth-passwordchanged.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/general/verify-email.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/auth-verifyemail.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/general/welcome.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/auth-welcome.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/general/coming-soon.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/auth-comingsoon.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/general/account-deactivated.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/auth-accountdeactivated.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/general/error-404.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/auth-404.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/general/error-500.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/auth-500.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                    ...
                                                    <div class="row g-10 pt-2 pb-5">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/user-profile/overview.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/profile-overview.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/user-profile/campaigns.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/profile-campaigns.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/user-profile/documents.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/profile-documents.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/user-profile/followers.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/profile-followers.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/user-profile/activity.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/profile-activity.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                    ...
                                                    <div class="row g-10 pt-2 pb-5">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/about.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/corporate-aboutus.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/contact.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/corporate-contactus.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/licenses.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/corporate-license.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/team.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/corporate-ourteam.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/sitemap.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/corporate-sitemap.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                    ...
                                                    <div class="row g-10 pt-2 pb-5">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/social/feeds.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/social-activity.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/social/activity.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/social-feeds.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/social/followers.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/social-followers.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/social/settings.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/social-settings.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                    ...
                                                    <div class="row g-10 pt-2 pb-5">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/faq/classic.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/faq-classic.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/faq/extended.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/faq-extended.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/blog/home.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/blog-home.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <a href="../../demo20/dist/pages/blog/post.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                                ...
                                                                <!--begin::Thumbnail-->
                                                                <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                                    <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/blog-post.png" class="lozad w-100 rounded" />
                                                                </span>
                                                                <!--end::Thumbnail-->
                                                            </a>
                                                            <!--end::Preview-->
                                            ...
                                            <div class="row g-10">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/account/settings.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/account-settings.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/account/billing.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/account-billing.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/account/security.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/account-security.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/account/referrals.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/account-referrals.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/account/logs.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/account-logs.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/account/api-keys.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/account-apikeys.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/account/statements.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/account-statements.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                            ...
                                            <div class="row g-10">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/general/view-users.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-viewfriends.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/general/upgrade-plan.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-upgradeplan.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/wizards/top-up-wallet.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-topupwallet.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/general/share-earn.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-shareandearn.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/general/select-users.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-selectuser.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/forms/bidding.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-placeyourbid.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/wizards/offer-a-deal.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-offeradeal.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/forms/new-target.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-newtarget.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/forms/new-card.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-newcard.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/forms/new-address.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-newaddress.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/general/invite-friends.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-invitefriend.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/wizards/create-project.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-createproject.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/wizards/create-campaign.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-createcampaign.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/wizards/create-account.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-createbusinessacc.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/wizards/create-app.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-createapp.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/forms/create-api-key.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-createapikey.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/modals/wizards/two-factor-authentication.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/modal-2factorauth.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                            ...
                                            <div class="row g-10">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/wizards/horizontal.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/wizard-2factorauth.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/wizards/horizontal.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/wizard-horizontal.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/wizards/vertical.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/wizard-vertical.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                            ...
                                            <div class="row g-10">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/search/users.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/search-users.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/search/horizontal.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/search-horizontal.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/search/vertical.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/search-vertical.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/utilities/search/select-location.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/search-location.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                            ...
                                            <div class="row g-10">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/widgets/charts.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/widgets-charts.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/widgets/feeds.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/widgets-feeds.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/widgets/lists.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/widgets-lists.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/widgets/mixed.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/widgets-mixed.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/widgets/statistics.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/widgets-stats.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/widgets/tables.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/widgets-tables.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                            ...
                                            <div class="row g-10">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/email/welcome-message.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/email-welcome.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/email/subscription-confirmed.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/email-subscriptionconfirmed.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/email/reset-password.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/email-resetpassword.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/email/card-declined.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/email-creditcarddeclined.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/email/promo-1.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/email-promo1.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/email/promo-2.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/email-promo2.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <a href="../../demo20/dist/authentication/email/promo-3.html" data-kt-href="true" class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                        ...
                                                        <!--begin::Thumbnail-->
                                                        <span class="app-sitemap-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 h-300px overflow-hidden">
                                                            <img src="<?= base_url('assets/'); ?>/media/preview/demos/placeholder.jpg" data-src="<?= base_url('assets/'); ?>/media/preview/sitemap/pages/email-promo3.png" class="lozad w-100 rounded" />
                                                        </span>
                                                        <!--end::Thumbnail-->
                                                    </a>
                                                    <!--end::Preview-->
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100 text-center">
                                    ...
                                    <div class="text-center px-4 py-15">
                                        <img src="<?= base_url('assets/'); ?>/media/illustrations/sketchy-1/9.png" alt="" class="mw-100 mh-300px" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                            </div>
                    ...
                    <form class="mx-auto mw-500px w-100 pt-15 pb-10" novalidate="novalidate" id="kt_modal_offer_a_deal_form">
                        ...
                        <div data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <!--begin::Illustration-->
                                <div class="text-center px-4">
                                    <img src="<?= base_url('assets/'); ?>/media/illustrations/sketchy-1/20.png" alt="" class="mw-100 mh-300px" />
                                </div>
                                <!--end::Illustration-->
                            </div>
                        </div>
