            ...
            <div class="card-header card-header-stretch">
                ...
                <div class="card-title d-flex align-items-center">
                    ...
                    <?php foreach ($tgl as $k) : ?>
                        <h4>Batas Akhir Pengisian Kuesioner : </h4>
                        <?= $k['tgl_selesai']; ?>
                    <?php endforeach; ?>
                </div>
                <!--end::Title-->
                        ...
                        <div class="timeline">
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content mb-10 mt-n1">
                                    ...
                                    <div class="pe-3 mb-5">
                                        <!--begin::Title-->
                                        <div class="fs-5 fw-semibold mb-2">You have received a new kuesioner:</div>
                                        <!--end::Title-->
                                        <!--begin::Description-->
                                    ...
                                    <?php $i = 1;
                                    foreach ($sMK as $s) {
                                        $tanggalData = $s['tgl_selesai'];
                                        $tanggalDuniaNyata = date('Y-m-d');
                                        if ($tanggalData >= $tanggalDuniaNyata) {
                                                ...
                                                <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed min-w-lg-600px flex-shrink-0 p-6">
                                                    ...
                                                    <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                                        ...
                                                        <div class="mb-3 mb-md-0 fw-semibold">
                                                            <h4 class="text-gray-900 fw-bold"><?= $s['matakuliah']; ?></h4>
                                                            <div class="fs-6 text-gray-700 pe-7"><?= $s['nama']; ?></div>
                                                        </div>
                                                        <!--end::Content-->
                                                        <!--begin::Action-->
                                                        <a href="<?= base_url(); ?>Kuesioner/formSurvei/<?= $s['id_survei_matakuliah']; ?>/<?= $s['idkm']; ?>" class="btn btn-primary px-6 align-self-center text-nowrap">Mulai Survey</a>
                                                        <!--end::Action-->
                                                    </div>
                                                    <!--end::Wrapper-->
                                                </div>
