<div class="d-flex flex-column flex-root">
    ...
    <div class="page d-flex flex-row flex-column-fluid">
        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div class="d-flex container-xxl align-items-stretch">
                        ...
                        <div class="d-flex align-items-center align-items-lg-stretch me-5 flex-row-fluid">
                            ...
                            <a href="../../demo20/dist/index.html" class="d-flex align-items-center">
                                <img alt="Logo" src="<?= base_url('assets/'); ?>media/logos/demo20.svg" class="h-25px h-lg-30px" />
                            </a>
                            <!--end::Logo-->
                            <!--begin::Tabs wrapper-->
                        ...
                        <div class="d-flex align-items-center ms-1">
                            ...
                            <!--begin::Menu toggle-->
                            <!--begin::Menu-->
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px" data-kt-menu="true" data-kt-element="theme-mode-menu" style="width:13%;">
                                <!--begin::Menu item-->
                        ...
                        <div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                ...
                                <div class="menu-item px-5">
                                    <a href="../../demo20/dist/authentication/layouts/corporate/sign-in.html" class="menu-link px-5">Log Out</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
            ...
            <?php
            $role_id = $this->session->userdata('usertype');
            ...
            <div class="header-navs d-flex align-items-stretch flex-stack h-lg-70px w-100 py-5 py-lg-0" id="kt_header_navs" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_navs_toggle" data-kt-swapper="true" data-kt-swapper-mode="append" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header'}">
                <!--begin::Container-->
                <div class="d-lg-flex container-xxl w-30">
                    <!--begin::Wrapper-->
                        ...
                        <div class="tab-content" data-kt-scroll="true" data-kt-scroll-activate="{default: true, lg: false}" data-kt-scroll-height="auto" data-kt-scroll-offset="70px">
                            ...
                            <div class="tab-pane fade active show" id="kt_header_navs_tab_1">
                                ...
                                <?php foreach ($menu as $m) : ?>
                                    <div class="header-menu flex-column align-items-stretch flex-sm-row">
                                        <!--begin::Menu-->
                                                ...
                                                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0 w-100 w-lg-850px">
                                                    ...
                                                    <div class="menu-state-bg menu-extended overflow-hidden overflow-lg-visible" data-kt-menu-dismiss="true">
                                                        <div class="row">
                                                            ...
                                                            <?php $subMenuCount = count($subMenu); ?>
                                                            <?php $halfCount = ceil($subMenuCount / 2); ?>
                                                            <div class="col-lg-6 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                                                                <!--begin:Row-->
                                                                <div class="row">
                                                                    <!--begin:Col-->
                                                                    <?php for ($i = 0; $i < $halfCount; $i++) : ?>
                                                                        <div class="col-lg-12 mb-3">
                                                                            <div class="menu-item p-0 m-0">
                                                                                <a href="<?= base_url($subMenu[$i]['url']) ?>" class="menu-link">
                                                                                    <span class="d-flex flex-column">
                                                                                        <i class="<?= $subMenu[$i]['icon']; ?>"></i>
                                                                                        <span class="fs-6 fw-bold text-gray-800 "><?= $subMenu[$i]['title'] ?></span>
                                                            ...
                                                            <div class="col-lg-6 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                                                                ...
                                                                <div class="row">
                                                                    <!--begin:Col-->
                                                                    <?php for ($i = $halfCount; $i < $subMenuCount; $i++) : ?>
                                                                        <div class="col-lg-12 mb-3">
                                                                            <div class="menu-item p-0 m-0">
                                                                                <a href="<?= base_url($subMenu[$i]['url']) ?>" class="menu-link">
                                                                                    <span class="d-flex flex-column">
